...
namespace P7.TwitterAuthentication.Events
{
    /// <summary>
    ...
    public class TwitterEvents : RemoteAuthenticationEvents
    {
        ...
        /// </summary>
        /// <param name="context">Contains redirect URI and <see cref="Microsoft.AspNetCore.Http.Authentication.AuthenticationProperties"/> of the challenge </param>
