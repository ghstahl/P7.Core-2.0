...
namespace P7.IdentityServer4.Common.Services
{
    public class CustomClaimsServiceHub : DefaultClaimsService
    {
        ...
        public override Task<IEnumerable<Claim>> GetAccessTokenClaimsAsync(ClaimsPrincipal subject, Resources resources,
            ValidatedRequest request)
        {
            ...
            {
                return customClaimsService.GetAccessTokenClaimsAsync(subject, resources, request);
            }
        }
    }
}
