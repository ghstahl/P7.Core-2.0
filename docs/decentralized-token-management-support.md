...

{
	...
	"scopes_supported": ["arbitrary", "nitro", "offline_access"],
	"claims_supported": [],
	"grant_types_supported": ["authorization_code", "client_credentials", "refresh_token", "implicit", "password", "public_refresh_token", "arbitrary_owner_resource"],
